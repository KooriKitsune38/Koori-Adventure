...
execute if score .mobsEnabled ka.Values matches 1 if score .entityCount ka.Values matches ..10 as @e[type=marker,tag=ka.Center,predicate=kadventure:c20] at @s run function kadventure:dungeon/summon_mobs