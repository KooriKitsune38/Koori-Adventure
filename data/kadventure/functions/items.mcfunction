...
# Eggs
    ...
    #> Fake Glass
    give @s ghast_spawn_egg{display:{Name:'{"text": "Fake Glass"}'},EntityTag:{id:"block_display",Tags:["ka.FakeGlass"],block_state:{Name:"minecraft:cyan_stained_glass"},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-.5f,0f,-.5f],scale:[1f,1f,1f]},Rotation:[0f,0f]}}