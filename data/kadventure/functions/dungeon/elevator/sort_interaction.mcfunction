...
execute if score .interactionUUID ka.Values = .playerUUID ka.Values run function kadventure:dungeon/elevator/instantiate_elevator with storage kadventure:variables