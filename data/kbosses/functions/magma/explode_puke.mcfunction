...
# Summon AEC
execute align y run summon area_effect_cloud ~ ~ ~ {Particle:"minecraft:dripping_dripstone_lava",effects:[{id:"minecraft:instant_damage",duration:1,amplifier:1b}],Duration:200,Radius:3}
